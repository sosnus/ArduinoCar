...
void MechaQMC5883::setAddress(int addr){
  address = addr;
}

void MechaQMC5883::WriteReg(int Reg,int val){
...
void MechaQMC5883::setMode(int mode,int odr,int rng,int osr){
...
void MechaQMC5883::read(int* x,int* y,int* z,int* a){
  read(x,y,z);
  *a = azimuth(y,x);
}
